...
export class BrandComponent implements OnInit {
        ...
        switch (field) {
            ...
            case "description":
                this.descriptionError =
                    this.newBrand.description === "" || this.newBrand.description.length > 50;
                break;
        }
    }
    ...
    onRowEditSave(brand: BrandData) {
        // // Kiểm tra trùng tên
        // const checkEqual = this.brand.find((o) => o.name === brand.name);
        // if (checkEqual) {
    ...
    onSaveNewBrand() {
        ...
        if (this.codeError || this.nameError || this.descriptionError) {
            ...
            // Kiểm tra trùng tên
            const checkEqual = this.brand.find((o) => o.name === this.newBrand.name);
            if (checkEqual) {
                // Nếu có tên trùng, hiển thị thông báo lỗi
                this.messageService.add({
                    severity: "error",
